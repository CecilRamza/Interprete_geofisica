...
filtro=filtrado("archivo.csv","eléctrica")
filtro.atipicos_electrica(logaritmo=True,metodo="LOF",vecinos=3,umbral=0.9)
filtro.guardar("archivo_filtrado.csv")
...
filtro.ondicula_magnetometria(columnas,resolucion_x=64,resolucion_y=64,malla=True,ventana=True,ondicula="db4",componentes=3,,pesos=[0,0.9,0.4,0],pesos2=[1,0.3,0.6,1])
